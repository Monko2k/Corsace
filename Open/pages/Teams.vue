<template>
    <div class="teams">
        <div class="teamsHeader">{{ $t('teams.list') }}</div>
        ...
        <div v-else-if="!inTeam && registered" @click="teamRegisteringToggle"><router-link to="/team" class="createTeam">{{ $t('teams.create') }}</router-link></div>
