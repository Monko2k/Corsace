<template>
    <div class="popupBody">
        ...
        <div class="discord">
            <div class="step">
                <div class="number">{{ $t('registration.step1') }}</div>
                <div class="divider">I</div>
                <div class="type">Discord</div>
            </div>
            <div class="input" v-if="!discordReg">
                <a class="instruction1" href="/api/auth/discord">{{ $t('registration.authenticate') }}</a>
            </div>
        ...
        <div class="osu">
            <div class="step">
                <div class="number">{{ $t('registration.step2') }}</div>
                <div class="divider">I</div>
                <div class="type">osu!</div>
            </div>
                
            <div class="input" v-if="discordReg">
                <a class="instruction1" href="/api/auth/osu">{{ $t('registration.authenticate') }}</a>
            </div>
        </div>
    </div>
</template>
